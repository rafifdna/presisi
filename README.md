...
5. In **Target → Info**, add:
   ...
   - Set **Bundle Identifier** to `com.mekari.netmonitor`
...
- `/Library/LaunchAgents/com.mekari.netmonitor.plist`
...
- Add payload **Application & Custom Settings**.
  - Easiest path: **External Applications → Custom Schema**, set the preference
    domain to `com.mekari.netmonitor`, and paste `jamf/netmonitor-schema.json`.
...
launchctl print gui/$(id -u)/com.mekari.netmonitor

# Confirm managed prefs landed
defaults read com.mekari.netmonitor
# or: cat "/Library/Managed Preferences/$USER/com.mekari.netmonitor.plist"
```
